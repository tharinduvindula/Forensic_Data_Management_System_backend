    ...
    public function getdeceased(Request $request){
        try{
            $records =DB::table('add_deceased')
                ...
                'add_deceased.policefullname', 'add_deceased.policetag', 'add_deceased.policearea','add_deceased.policerank','add_deceased.policephoneno','add_deceased.policedate', 'add_deceased.policescenephoto', 'add_deceased.policefoldername',
            ...
            try{
                    ...
                    ->update([
                        ...
                        foreach($gaspecimens as $gaspecimen){
                                ...
                                $records =DB::table('ga')
                                ->where('ctnumber',request(['gactnumber']))
                                ->update([
                                    "blood"=>$blood,
                                    "urine"=>$urine,
                                    "liver"=>$liver,
                                    ...
                                    foreach($mrispecimens as $mrispecimen){
                                            ...
                                            $records =DB::table('mri')
                                            ->where('refnumber',request(['mrirefnum']))
                                            ->update([
                                                "blood"=>$blood,
                                                "urine"=>$urine,
                                                "liver"=>$liver,
                                                ...
                                                foreach($otherspecimens as $otherspecimen){
                                                        ...
                                                        ->where('refnumber',request(['otherrefnum']))
                                                        ->update([
                                                            "blood"=>$blood,
                                                            "urine"=>$urine,
                                                            "liver"=>$liver,
